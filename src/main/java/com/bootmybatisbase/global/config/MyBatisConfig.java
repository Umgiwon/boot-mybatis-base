...
public class MyBatisConfig {
     ...
     * MyBatis가 Spring TransactionManager을 사용할 수 있도록 SpringManagedTransactionFactory 지정
     */
    @Bean
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource) throws Exception {
        ...
        factoryBean.setTransactionFactory(new SpringManagedTransactionFactory()); // 트랜잭션 처리방식을 Spring 트랜잭션에 완전히 위임
